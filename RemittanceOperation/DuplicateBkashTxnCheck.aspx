<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="DuplicateBkashTxnCheck.aspx.cs" Inherits="RemittanceOperation.DuplicateBkashTxnCheck" %>
    ...
    <table style="width: 100%; border: solid 1px; padding-top: 20px;">
        <tr>
            <td colspan="4" style="font-weight: bold; text-decoration: underline;">
                <asp:Label ID="Label5" runat="server" Text="Duplicate bKash Transactions Check"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>&nbsp;</td>
        ...
        <tr>
            <td colspan="2" style="width: 490px;">
               ...
               <asp:Button ID="btnBkashDuplicateTxnSearch" runat="server" Text="Search" Width="100px" OnClientClick="return TxnSearch();" OnClick="btnBkashDuplicateTxnSearch_Click"   />&nbsp;&nbsp;
        ...
        <tr>
            <td colspan="4">
                ...
                <asp:Panel ID="Panel3" runat="server" ScrollBars="Both" Width="950px" Height="300px">
                    <asp:GridView ID="dataGridViewBkashDuplicateTxn" runat="server" BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4" ShowHeaderWhenEmpty="True" Font-Size="Small">
