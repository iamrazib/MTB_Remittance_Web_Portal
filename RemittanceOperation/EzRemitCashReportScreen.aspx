<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="EzRemitCashReportScreen.aspx.cs" Inherits="RemittanceOperation.EzRemitCashReportScreen" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <table style="width: 100%; margin-left: 30px;">
                <tr>
                    <td colspan="4" style="font-weight: bold; text-decoration: underline; text-align: center;">
                        <asp:Label ID="Label1" runat="server" Text="EzRemit Cash Report"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                ...
                <tr>
                    <td>
                        <asp:Label ID="lblEzRemitRptTotalRows" runat="server" Text=""></asp:Label></td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                </tr>
    ...
    <div style="margin-left: 30px;">
        <asp:Button ID="btnDownloadEzRemitRptAsExcel" runat="server" Text="Download As Excel" Width="150px" OnClick="btnDownloadEzRemitRptAsExcel_Click"  />
    </div>
