<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="GCCReportScreen.aspx.cs" Inherits="RemittanceOperation.GCCReportScreen" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <table style="width: 100%; margin-left:30px;">
                <tr>
                    <td colspan="4" style="font-weight: bold; text-decoration: underline; text-align:center;">
                        <asp:Label ID="Label1" runat="server" Text="GCC Cash Report"></asp:Label>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>
                        <asp:Label ID="lblGCCRptTotalRows" runat="server" Text=""></asp:Label></td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
    ...
    <div style="margin-left:30px;">
        <asp:Button ID="btnDownloadGCCRptAsExcel" runat="server" Text="Download As Excel" Width="150px" OnClick="btnDownloadGCCRptAsExcel_Click" />
    </div>
