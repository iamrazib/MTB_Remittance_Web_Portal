<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="GCCcashTxnPassing.aspx.cs" Inherits="RemittanceOperation.GCCcashTxnPassing" %>
            ...
            <table style="width: 100%; margin-top:20px; margin-left:15px;">
                <tr>
                    <td colspan="4" style="font-weight: bold; text-decoration: underline; text-align:center;">
                        <asp:Label ID="Label1" runat="server" Text="GCC Over The Counter Payment"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                ...
                <tr style="padding-left:20px;">
                    ...
                    <td><asp:Button ID="btnSearch" runat="server" Text="Search" Width="120px" OnClick="btnSearch_Click" OnClientClick="return TxnSearch();" /></td>
                    <td>&nbsp;</td>
                </tr>
                <tr style="padding-left:20px;">
                ...
                <tr>
                    <td>&nbsp;</td>
                    <td>
                        <asp:Button ID="btnPayment" runat="server" Text="Payment" Width="120px"  OnClick="btnPayment_Click" OnClientClick="return ConfirmUpdate();" />
                    </td>
                    <td colspan="2">
