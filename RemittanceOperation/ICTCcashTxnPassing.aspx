<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ICTCcashTxnPassing.aspx.cs" Inherits="RemittanceOperation.ICTCcashTxnPassing" %>
            ...
            <table style="width: 100%; margin-top:20px; margin-left:15px;">
                <tr>
                    <td colspan="4" style="font-weight: bold; text-decoration: underline; text-align:center;">
                        <asp:Label ID="Label1" runat="server" Text="ICTC Over The Counter Payment"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                ...
                <tr style="padding-left:20px;">
                    <td>ID Type:</td>
                    <td><asp:DropDownList ID="cbIDType" runat="server"></asp:DropDownList></td>
                ...
                <tr>
                    <td>&nbsp;</td>
                    <td>
                        <asp:Button ID="btnPayment" runat="server" Text="Payment" Width="120px" BackColor="LightGreen" ForeColor="Black" Font-Bold="true" OnClientClick="return ConfirmPayment();" OnClick="btnPayment_Click" />
                    </td>
                    <td colspan="2">
                ...
                <tr>
                    <td>&nbsp;</td>
                    <td colspan="2">
                        <asp:Button ID="btnUnlock" runat="server" Text="Unlock If Not Paid" BackColor="LightSalmon" ForeColor="Black" Font-Bold="true" Width="180px" OnClientClick="return ConfirmUnlock();" OnClick="btnUnlock_Click" />
                    </td>
                    <td>
                        <asp:Label ID="lblUnlockMsg" runat="server" Text="" ForeColor="Red"></asp:Label>
                    </td>
                </tr>
            </table>
            <br />
