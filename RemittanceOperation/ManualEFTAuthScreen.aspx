<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ManualEFTAuthScreen.aspx.cs" Inherits="RemittanceOperation.ManualEFTAuthScreen" %>
        ...
        <table style="width: 100%; border: solid 1px; margin-left: 15px;">
            <tr>
                <td colspan="3" style="font-weight: bold; text-decoration: underline; text-align: center;">
                    <asp:Label ID="Label2" runat="server" Text="Manual EFT File Authorize"></asp:Label>
                </td>
            </tr>            
            <tr>
            ...
            <tr>
                ...
                <td>
                    <asp:Button ID="btnSearchUnAuthorizedTxn" runat="server" Text="Search" Width="100px" OnClientClick="return TxnSearch();" OnClick="btnSearchUnAuthorizedTxn_Click" />
            ...
            <tr>
                ...
                <td colspan="2">
                    ...
                    <asp:GridView ID="dataGridViewTxnToAuthorize" runat="server" BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4" ShowHeaderWhenEmpty="True">
            ...
            <tr>
                <td>&nbsp;</td>
                <td colspan="2">
                    <asp:Button ID="btnAuthFileTxn" runat="server" Text="Authorize" Width="110px" OnClientClick="return ConfirmAuthorize();" OnClick="btnAuthFileTxn_Click" />
            ...
            <tr>
                <td>&nbsp;</td>
                <td colspan="2">
                    <asp:Label ID="Label4" runat="server" Text="Output List : "></asp:Label><br />
                    <%--<asp:Panel ID="Panel2" runat="server" BorderWidth="1px" ScrollBars="Both" Width="600px" Height="100px">--%>
                        <asp:TextBox ID="listBoxAuthOutput" runat="server" Height="100px" TextMode="MultiLine" Width="600px" ReadOnly="true" style="resize:none"></asp:TextBox>
                    <%--</asp:Panel>--%>
                </td>
            </tr>
        </table>
