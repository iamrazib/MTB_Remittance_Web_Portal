<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="MonitorMTBAcTxn.aspx.cs" Inherits="RemittanceOperation.MonitorMTBAcTxn" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table style="width: 100%; border: solid 1px; padding-top: 20px;">
        <tr>
            <td colspan="4" style="font-weight: bold; text-decoration: underline;">
                <asp:Label ID="Label5" runat="server" Text="Failed MTB Transactions"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>&nbsp;</td>
        ...
        <tr>
            <td colspan="3" style="width: 490px;">
               ...
               <asp:Button ID="btnMTBFailedTxnSearch" runat="server" Text="Search" Width="100px" OnClientClick="return TxnSearch();" OnClick="btnMTBFailedTxnSearch_Click"   />&nbsp;&nbsp;
        ...
        <tr>
            <td colspan="4">
                ...
                <asp:Panel ID="Panel3" runat="server" ScrollBars="Both" Width="900px" Height="250px">
                    <asp:GridView ID="dataGridViewMtbFailedTxn" runat="server" BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4" ShowHeaderWhenEmpty="True" Font-Size="Small">
    ...
    <table style="width: 100%; border: solid 1px; padding-top: 20px;">
        <tr>
            <td colspan="4" style="font-weight: bold; text-decoration: underline;">
                <asp:Label ID="Label1" runat="server" Text="Successful MTB Transactions"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>&nbsp;</td>
        ...
        <tr>
            <td colspan="3" style="width: 490px;">
               ...
               <asp:Button ID="btnMTBSuccessTxnSearch" runat="server" Text="Search" Width="100px" OnClientClick="return TxnSearch();" OnClick="btnMTBSuccessTxnSearch_Click"  />&nbsp;&nbsp;
        ...
        <tr>
            <td colspan="4">
                ...
                <asp:Panel ID="Panel1" runat="server" ScrollBars="Both" Width="900px" Height="250px">
                    <asp:GridView ID="dataGridViewMtbSuccessfulTxn" runat="server" BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4" ShowHeaderWhenEmpty="True" Font-Size="Small">
                        <FooterStyle BackColor="#FFFFCC" ForeColor="#330099" />
                        <HeaderStyle BackColor="#990000" Font-Bold="True" ForeColor="#FFFFCC" />
                        <PagerStyle BackColor="#FFFFCC" ForeColor="#330099" HorizontalAlign="Center" />
                        <RowStyle BackColor="White" ForeColor="#330099" />
